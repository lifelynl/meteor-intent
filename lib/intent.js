...
Intent = (function(Iron, Router) {
    ...
    var _back = function(route_name, fallback_route) {
        ...
        if (intent) delete _intents[route_name];
    };
    ...
    var API = {
         ...
         * @memberof Intent
         *
         * @param c {Object} Configuration object
         * @param c.debug {Boolean} Enable debugging mode (logs some info to the console)
         * @param c.default_route_name {String} Set default route name
         * @param c.default_route_params {Object} Set default route params
         * @param c.default_route_options {Object} Set default route options
         */
        configure: function(c) {
            ...
            // default_route_name
            if (c.default_route_name && _validate.route_name(c.default_route_name))
                _configuration.default_route_name = c.default_route_name;

            // default_route_params
            if (c.default_route_params && _validate.route_params(c.default_route_params))
                _configuration.default_route_params = c.default_route_params;

            // default_route_options
            if (c.default_route_options && _validate.route_options(c.default_route_options))
                _configuration.default_route_options = c.default_route_options;
        },
        ...
        go: function(route_args, callback, intent_options) {
            ...
            var options = {
                prevent_going_back: intent_options && !!intent_options.prevent_going_back ? !!prevent_going_back : false
            };
        ...
        return: function(route_name, return_options) {
            ...
            if (intent && intent.callback) {
                ...
                options.fallback_action(options.arguments);
